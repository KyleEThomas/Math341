...
age <- read.csv(file = "~/Desktop/CSUN/2021/Math 341/Data Files/ageguesses.csv", head = TRUE)
...
movies <- read.csv(file = "~/Desktop/CSUN/2021/Math 341/Data Files/HollywoodMovies.csv", head = TRUE)
